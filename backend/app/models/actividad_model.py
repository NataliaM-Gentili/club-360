...
from app.models.db_structure import OfrecimientoReserva
...
class ActividadModel:
    ...
    # Modificado para dejar de mostrar los turnos de reservas mensuales que fueron cancelados y catch de errores
    @staticmethod
    def get_actividades(id_cliente):
        try:
            ...
            turnos_ofrecidos = (
                ...
                .join(
                    OfrecimientoReserva,
                    OfrecimientoReserva.id_reserva == ReservaTurno.id_reserva
                )
                .filter(
                    OfrecimientoReserva.cliente_emisor == id_cliente,
                )
            )
